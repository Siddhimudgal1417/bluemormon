    ...
    <>
      <section className="section-lg bg-gradient-to-br from-navy-900 to-navy-800 text-white relative overflow-hidden">
        <Reveal className="container-premium text-center">
          <p className="text-small text-coral-300 mb-6">READY TO EXPLORE?</p>
          ...
          <div className="flex items-center justify-center gap-6 flex-wrap">
            <Link to="/contact" className="btn bg-coral-500 hover:bg-coral-600 text-white border-0 px-8 py-4 transition-all duration-300">
              Plan Your Trip
            </Link>
      ...
      <footer className="bg-navy-900 text-white py-16">
        <div className="container-premium mb-12">
          <div className="grid md:grid-cols-4 gap-12 mb-12 pb-12 border-b border-white/10">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-coral-500">Explore</h4>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link to="/destinations" className="text-white/70 hover:text-coral-400 transition">
                    Destinations
                  </Link>
                </li>
                <li>
                  <Link to="/packages" className="text-white/70 hover:text-coral-400 transition">
                    Packages
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="text-white/70 hover:text-coral-400 transition">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link to="/testimonials" className="text-white/70 hover:text-coral-400 transition">
                    Testimonials
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-coral-500">Get in Touch</h4>
              <ul className="space-y-3 text-sm">
                <li className="flex items-start gap-2">
                  <Phone size={16} className="text-coral-500 mt-0.5" />
                  <a href="tel:+1234567890" className="text-white/70 hover:text-coral-400 transition">
                    +1 (234) 567-890
                  </a>
                </li>
                <li className="flex items-start gap-2">
                  <Mail size={16} className="text-coral-500 mt-0.5" />
                  <a href="mailto:hello@bluemonormon.com" className="text-white/70 hover:text-coral-400 transition">
                    hello@bluemonormon.com
                  </a>
                </li>
                <li className="flex items-start gap-2">
                  <MapPin size={16} className="text-coral-500 mt-0.5" />
            ...
            <div>
              <h4 className="font-semibold mb-4 text-coral-500">Follow</h4>
              <div className="flex gap-4">
                <a href="#" className="text-white/70 hover:text-coral-400 transition">
                  <Facebook size={20} />
                </a>
                <a href="#" className="text-white/70 hover:text-coral-400 transition">
                  <Instagram size={20} />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 text-sm text-white/60">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              <a href="#" className="hover:text-coral-400 transition">
                Privacy Policy
              </a>
              <a href="#" className="hover:text-coral-400 transition">
                Terms of Service
